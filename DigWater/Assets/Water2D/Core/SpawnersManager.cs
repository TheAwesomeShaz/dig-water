...
#if UNITY_EDITOR
                instance.setFloatToShader("isGammaColor", PlayerSettings.colorSpace == ColorSpace.Gamma ? 1f : 0f, _spawner.WaterMaterial);
               //instance.setFloatToShader("isGammaColor", 0f, _spawner.WaterMaterial);
#endif
            }
            else {
